...
const query = {
    Query: {
        ...
        historyDrivers(_, { pageElement, page }, { dataSources }) {
            return __awaiter(this, void 0, void 0, function* () {
                return yield dataSources.drivers.getDrivers(pageElement, page).then((data) => data.MRData.DriverTable.Drivers);
            });
        },
        ...
        seasonPilotsRanking(_, { year }, { dataSources }) {
            return __awaiter(this, void 0, void 0, function* () {
                return yield dataSources.drivers.getSeasonPilotsRanking(year).then((data) => data.MRData.StandingsTable.StandingsLists[0].DriverStandings);
            });
        },
        historyCircuits(_, { pageElement, page }, { dataSources }) {
            return __awaiter(this, void 0, void 0, function* () {
                return yield dataSources.circuits.getCircuits(pageElement, page).then((data) => data.MRData.CircuitTable.Circuits);
            });
        },
